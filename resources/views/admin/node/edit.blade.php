    ...
    <article class="page-container">
        ...
        <form action="{{route('admin.node.store')}}" method="post" class="form form-horizontal" @submit.prevent="dopost" >
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$node->name}}" name="name" v-model.lazy="info.name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3">路由别名：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"   value="{{$node->route_name}}" name="route_name" v-model="info.route_name" >
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                    <div class="radio-box">
                        <input name="is_menu" type="radio"  value="{{$node->is_menu}}" v-model="info.is_menu " checked>
                        <label for="sex-1">否</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" v-model="info.is_menu " value="{{$node->is_menu}}" name="is_menu">
