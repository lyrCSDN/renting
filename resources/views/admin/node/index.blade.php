...
{{--                        </td>--}}
                        ...
                        <td class="td-manage">
                            <a href="{{route('admin.node.edit',['id'=>$item['id']])}}" class="label label-waring radius ">修改</a>
                            <a href="{{route('admin.node.destroy',['id'=>$item['id']])}}" class="label label-success radius delbtn">删除</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
